      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="profile.html">
            ...
            <span class="nav-link-text ms-1">Admin Mgt</span>
          </a>
        </li>
        <li class="nav-item">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              ...
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none" ><a href="#" style="font-weight: bold;"><?php echo $name; ?></a></span> 
                <span class="d-sm-inline d-none" style="margin-left: 60px;" ><a href="Logout.php" style="color: red;font-weight: bold;">Sign Out</a></span>
              </a>
            </li>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold"> Product Inquiries</p>
                    <h5 class="font-weight-bolder mb-0">
                      43
                      <span class="text-danger  text-sm font-weight-bolder">Not Marked  1</span>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Added Projects </p>
                    <h5 class="font-weight-bolder mb-0">
                     25
                    </h5>
                  </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Vacancy Applies</p>
                    <h5 class="font-weight-bolder mb-0">
                      3
                    </h5>
                  </div>
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card z-index-2">
            <div class="card-body p-3">
              ...
              <h6 class="ms-2 mt-4 mb-0"> Career Vacancies </h6>
                ...
                <div class="row">
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Replied</p>
                    </div>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Accepted</p>
                    </div>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Not Marked</p>
                    </div>
                    <h4 class="font-weight-bolder">2</h4>
                    <div class="progress w-75">
                      <div class="progress-bar bg-dark w-5" role="progressbar" aria-valuenow="2" aria-valuemin="0" aria-valuemax="1"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="#" class="font-weight-bold" target="_blank">Dockyard Total Solutions (Pvt) Ltd.</a>
